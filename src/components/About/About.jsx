    ...
    <>
      ...
      >
        <div className="container" style={myStyle}>
          <div className="row">
            <div
              className={`${styles.intro} d-flex flex-column justify-content-center col-lg-4  col-sm-12`}
            >
              <div>
                <p className="pb-1 fw-bolder">Hello, my name is Hardik Singh</p>
                <div className={styles.typeEffect} data-aos="fade-up">
                  <h2>I'm a Front-end Developer&lt;/&gt;</h2>
                </div>
              </div>
              <div
                className={`${styles.social} d-flex  justify-content-md-start justify-content-center gap-5 mt-5`}
                data-aos="fade-down"
              >
            ...
            <div className={`${styles.about}  col-lg-8 col-sm-12 pb-3`}>
